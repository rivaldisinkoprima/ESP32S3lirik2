...
const char* deret1[] = {"DERET 1", "1. SABUN", "2. KUDA", "3. DINGIN", "4. BANYAK", "5. GULA", 
...
const char* deret6[] = {"DERET 6","1. IMAN", "2. POLA", "3. BUKIT", "4. LIBUR", "5. GADIS", "6. DAPUR",
...
const char* deret7[] = {"DERET 7", "1. SUNTIK", "2. BARU", "3. NYAWA", "4. KECAP", "5. BOLA", "6. MAKAN",
                        "7. MURID", "8. SAMPAH","9. NENEK", "10. LEHER", "11. ASIN", "12. KABEL", "13. SOAL", "14. KAIN",
                        "15. TIDUR", "16. BAIK", "17. GURU", "18. RUMPUT", "19. DIAM", "20. PLASTIK"};

const char* deret8[] = {"DERET 8","1. TAKSI", "2. PERUT", "3. NONA", "4. PISANG", "5. HUKUM", "6. MEJA",
...
const char* deret9[] = {"DERET 9", "1. HATI", "2. KOLAM", "3. BUTA", "4. YAKIN", "5. GEMUK", "6. DINAS",
                        "7. BUDI", "8. LUPA","9. KERIS", "10. KOPI", "11. AMAL", "12. TAMU", "13. LEMBUR", "14. SANDANG",
                        "15. KECIL", "16. BANJIR", "17. PANAS", "18. MURAH", "19. TUAN"};

const char* deret10[] = {"DERET 10", "1. TEMPO", "2. PINTU", "3. HOTEL", "4. MINYAK", "5. BASAH", "6. MODAL",
...
void lirik(){
  ...
  if(!running) return;   // penting, stop menghentikan counting
...
void listderet() {
            ...
            if (deret==3)words = words3;
            if (deret==4)words = words4;
            if (deret==5)words = words5;
            if (deret==6)words = words6;
            if (deret==7)words = words7;
            if (deret==8)words = words8;
            if (deret==9)words = words9;
            if (deret==10)words = words10;
}
